    ...
    return (
        <div className="mx-5 md:mx-40 my-10 md:my-20">
            ...
            <div className="mt-10 md:mt-0 mb-10 md:mb-20 text-center">
                <NavLink to="/our-menu"><button className="uppercase px-4 py-2 text-xl text-black hover:bg-black hover:text-white hover:duration-700 hover:cursor-pointer border-b-2 border-black rounded-3xl mt-0 md:mt-10">View Full Menu</button></NavLink>
            </div>
        </div>
    );
};
